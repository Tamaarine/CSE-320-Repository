...
#endif
{
  ...
  while(1)
  {
    ...
    {
      case 'f':
          in_language = find_keyword(t_language, NBLANGUAGES, DEFAULT_INPUT_LANGUAGE, optarg, TRUE);
        break;
      case 't':
          out_language = find_keyword(t_language, NBLANGUAGES, DEFAULT_OUTPUT_LANGUAGE, optarg, TRUE);
        break;
      case 'o':
      ...
      case 'b':
        ...
        break;
      case 'd':
        driver = find_keyword(t_output, NB_DRIVER, DEFAULT_DRIVER, optarg, TRUE);
        break;
      case 'i':
